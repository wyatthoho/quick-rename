...
def create_label(master: tk.Frame, row: int, col: int, text: str, font: font) -> tk.Label:
...
def create_entry(master: tk.Frame, row: int, col: int, font: font, width: int = None, textvariable: tk.StringVar = None) -> tk.Entry:
    entry = tk.Entry(
        master,
...
def create_checkbutton(master: tk.Frame, row: int, col: int, text: str, font: font, command: Callable, variable: tk.IntVar) -> tk.Checkbutton:
...
def create_radiobutton(master: tk.Frame, row: int, col: int, text: str, font: font, variable: tk.IntVar, value: int) -> tk.Radiobutton:
...
def create_listbox_with_scrollbar(master: tk.LabelFrame, row: int, col: int, font: font) -> tk.Listbox:
